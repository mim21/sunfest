...
# One-line summary per event, distilled from its sunfest.co.il description page
# (the few without a page are summarised from the schedule). Shown on each card.
SUMMARY = {
    'Круг знакомства': 'Групповые упражнения на живой контакт и знакомство участников в начале фестиваля.',
    'Медитация «Львиное сердце»': 'Практика открытия сердца через личные границы и опору в себе.',
    'Добаюкивание': 'Покачивание в гамаке для восстановления базового доверия и пренатального опыта.',
    'Внутренний ребёнок и исцеление детских травм': 'Медитация и осознание детских ролей для контакта с внутренним ребёнком.',
    'Аюрведические секреты красоты: сияние изнутри': 'Аюрведические ритуалы ухода, самомассаж лица и дыхание для здоровья кожи.',
    'Звучать всем телом': 'Раскрытие голоса через движение, дыхание и импровизацию, снятие зажимов.',
    'ГДЕ МОИ ДЕНЬГИ? Ловушка духовности и проработок': 'Проработка денежных блоков и убеждений, мешающих брать деньги.',
    'Исцеляющее касание': 'Практика осознанного прикосновения в парах, слушание тела и границ.',
    'Официальное открытие фестиваля. Концерт Frisson Trio': 'Концерт трио из скрипки, виолончели и ханга — смесь классики, фолка и этники.',
    'Хатха-йога': 'Утренние асаны, дыхание и техника Наули для самостоятельной практики.',
    'Дыхание с Источником': 'Дыхательные техники для проработки трёх личных ситуаций за занятие.',
    'Гвоздестояние. Тело помнит всё!': 'Стояние на гвоздях с дыханием, звуком и работой в парах.',
    'Смехо-йога': 'Дыхательные упражнения йоги в сочетании с практикой искусственного смеха.',
    'Цигун': 'Медленные осознанные движения с дыханием в стиле Нейгун.',
    'Психосоматическая реабилитационная кинезиология': 'Диагностика тела и приёмы самопомощи на стыке психосоматики и физиотерапии.',
    'Безлимитная мотивация, или Как добиться успеха': 'Как планировать и разбивать сложные задачи на выполнимые шаги.',
    'Голос души: навигация по Хьюман Дизайну': 'Телесные и дыхательные практики для распознавания внутреннего согласия тела.',
    'Процессуальная работа: услышать и проявить скрытое в себе': 'Учимся замечать сигналы тела и проявлять подавленные части себя.',
    '«Быть в потоке». Нейрографика': 'Осознанность, работа с мышлением и рисование для внутреннего равновесия.',
    'Ментальное здоровье и целостность': '120-дневная система чистого мышления для устойчивости и ясности.',
    'Алхимия прикосновения': 'Практика взгляда, заботы о себе и доверительного прикосновения в контакте.',
    '4 вида наслаждения': 'Разбор четырёх типов удовольствия и переход к устойчивому благополучию.',
    'Аутентичное движение': 'Свободное движение с закрытыми глазами в присутствии наблюдателя-свидетеля.',
    'AI и человек будущего: как ИИ меняет бизнес и жизнь': 'Лекция о том, как ИИ меняет профессии, работу и бизнес.',
    'Естественное звучание': 'Пение и гудение гласных с дыханием под звуковые инструменты.',
    'Женский круг с нейрографическими практиками «ПЕРЕХОД»': 'Женщины рисуют нейрографику, прорабатывая переход в новый жизненный этап.',
    'Танец отношений': 'Парные двигательные упражнения, проигрывающие этапы отношений через тело.',
    'Пробуждение внутреннего целителя': 'Упражнения и медитация для работы с энергией и самопомощи.',
    'Массаж в 10 рук с музыкальным сопровождением': 'Лёжа, человек получает массаж нескольких мастеров под живую музыку.',
    'Нейрографика. Язык Вселенной: линии, меняющие реальность': 'Рисование линий и символа Анкх с концентрацией на личных целях.',
    'Линия времени': 'Демонстрация транса и регрессии в прошлое для проработки детских травм.',
    'Искусство быть желанной. Коды женского соблазна (для девушек)': 'Занятие для женщин о привлекательности, сексуальности и динамике в паре.',
    'PRO отношения 3.0 (только для мужчин)': 'Лекция для мужчин о построении близости и ошибках в отношениях.',
    'Дао эмоций': 'Изучаем базовые эмоции, их циклы и способы управления ими.',
    'Алхимия дыхания': 'Дыхательные упражнения для проработки травм и восстановления энергии.',
    'Женский сакральный танец': 'Танец для самопознания, расслабления и наполнения женской энергией.',
    'Тайская йога': 'Мягкие растяжки, скручивания и статические позы с осознанным дыханием.',
    'Интуитивный контактный танец': 'Импровизация в парах через спонтанное движение и контакт тел.',
    'Воплощение мечты — сейчас!': 'Техники НЛП и звукотерапия ханга для работы над мечтой.',
    'Путь с Отцом': 'Переписывание внутреннего образа отца через демонстрацию метода.',
    'Бизнес-расстановки: деньги, команда и энергия роста': 'Демонстрационные расстановки и практики в группах для выявления блоков в бизнесе.',
    'Голос как энергия': 'Работа с дыханием, эмоциями и вокальными техниками для развития голоса.',
    'Отношения: от первой искры до зрелой любви': 'Исследование сценариев привлечения, типов отношений и причин конфликтов.',
    'Тибетские чаши. Звук, который ведёт': 'Учимся извлекать звук тибетскими чашами и работать с вибрацией.',
    # No dedicated page — summarised from the schedule:
    'Праздник Летнего Солнцестояния: прыжки через костёр, музыкальный джем': 'Прыжки через костёр и музыкальный джем в честь летнего солнцестояния.',
    'Практики управления энергией': 'Практики управления и направления личной энергии.',
    'Экстатик-денс в наушниках (дресс-код белый), джем, посиделки у костра': 'Танцы под музыку в наушниках, джем и посиделки у костра.',
    'Закрытие фестиваля. Саундхиллинг, интеграция': 'Завершающий саундхиллинг и интеграция опыта фестиваля.',
}
...
def make_workshop(day, start, end, master, title):
    ...
    if master:
        desc = f'Ведущий: {master}.' + (f' {summary}' if summary else '')
    else:
        desc = summary  # festival-wide events: no facilitator line, summary only
    raw = f'{day} июня 2026'
    return {
        'title': title,
        'event_type': etype,
